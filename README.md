...
<div align="center">
<h1> <b>TDD[ Test-Driven Development ]</b> <hr/>
...
```sh
  cd my-folder
  git clone https://github.com/TaiwoEnoch/TDD_PROJECT.git
```
...
Feel free to check the [issues page](https://github.com/TaiwoEnoch/TDD_PROJECT/issues).
